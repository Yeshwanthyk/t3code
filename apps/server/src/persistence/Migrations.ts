...
import Migration0033 from "./Migrations/033_ProjectionThreadSessionPendingBackgroundTasks.ts";
...
export const migrationEntries = [
  ...
  [33, "ProjectionThreadSessionPendingBackgroundTasks", Migration0033],
] as const;
